...
"""Communication interface for the ACC SCA application on OpenTitan.
...
class OTACC:
    ...
    def _ujson_acc_sca_cmd(self):
        self.target.write(json.dumps("AccSca").encode("ascii"))
        time.sleep(0.003)
    ...
    def init(
        ...
        """Initializes the Acc SCA tests on the target.
    ...
    def init_keymgr(self):
        """Initializes the key manager for ACC on the target."""
        # AccSca command.
        self._ujson_acc_sca_cmd()
    ...
    def key_sideload_fvsr(self, seed: int):
        """Starts the key sidloading FvsR test on ACC.
        Args:
    ...
    def ecdsa_p256_sign(self, masking_on: bool, msg, d0, k0):
        """Starts the EcdsaP256Sign test on ACC.
        Args:
    ...
    def ecdsa_p256_sign_batch(self, num_traces: int, masking_on: bool, msg, d0, k0):
        """Starts the EcdsaP256SignBatch test on ACC.
        Args:
    ...
    def ecdsa_p256_sign_batch_fvsr(
        ...
        """Starts the EcdsaP256SignFvsrBatch test on ACC.
        Args:
            num_traces: Number of batch operations.
            masking_on: Turn on/off masking.
            msg: Message array (8xuint32_t)
