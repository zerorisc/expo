...
/**
 * Start an async P-384 keypair generation operation on ACC.
 *
...
/**
 * Finish an async P-384 keypair generation operation on ACC.
 *
...
/**
 * Start an async P-384 sideloaded keypair generation operation on ACC.
 *
 * Appropriate for both ECDSA and ECDH; the key-generation process is the same.
 *
...
/**
 * Finish an async P-384 sideloaded keypair generation operation on ACC.
 *
 * This routine will only read back the public key, instead of both public and
 * private as with `p384_ecdsa_keygen_finalize`. Blocks until ACC is idle.
 *
...
/**
 * Start a P-384 public key on-curve check on ACC.
 *
 * Blocks until ACC is idle.
 *
...
/**
 * Finish a P-384 public key on-curve check on ACC.
 *
 * Blocks until ACC is idle.
 *
...
/**
 * Start an async ECDSA/P-384 signature generation operation on ACC.
 *
 * Returns an `OTCRYPTO_ASYNC_INCOMPLETE` error if ACC is busy.
 *
...
/**
 * Finish an async ECDSA/P-384 signature generation operation on ACC.
 *
...
/**
 * Start an async ECDSA/P-384 signature verification operation on ACC.
 *
...
/**
 * Finish an async ECDSA/P-384 signature verification operation on ACC.
 *
 * See the documentation of `p384_ecdsa_verify` for details.
 *
 * Blocks until ACC is idle.
...
/**
 * Start an async ECDH/P-384 shared key generation operation on ACC.
 *
 * Returns an `OTCRYPTO_ASYNC_INCOMPLETE` error if ACC is busy.
 *
...
/**
 * Finish an async ECDH/P-384 shared key generation operation on ACC.
 *
 * Blocks until ACC is idle.
 *
