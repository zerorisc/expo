...
module chip_darjeeling_no_ibex_cw310 #(
...
// otherwise Verilator / FPGA will hang.
  ...
  assign clk_trans_idle = top_darjeeling_no_ibex.clkmgr_aon_idle[trigger_sel];
...
endmodule : chip_darjeeling_no_ibex_cw310
