...
impl TryFrom<u32> for PlicPeripheral {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            4 => Ok(Self::I2c0),
            5 => Ok(Self::OtpCtrl),
            6 => Ok(Self::AlertHandler),
            7 => Ok(Self::SpiHost0),
            8 => Ok(Self::PwrmgrAon),
            9 => Ok(Self::AonTimerAon),
            10 => Ok(Self::SocProxy),
            11 => Ok(Self::Hmac),
            12 => Ok(Self::Kmac),
            13 => Ok(Self::Otbn),
...
pub enum PlicIrqId {
    ...
    OtpCtrlOtpOperationDone = 65,
    /// otp_ctrl_otp_error
    OtpCtrlOtpError = 66,
    /// alert_handler_classa
    AlertHandlerClassa = 67,
    /// alert_handler_classb
    AlertHandlerClassb = 68,
    /// alert_handler_classc
    AlertHandlerClassc = 69,
    /// alert_handler_classd
    AlertHandlerClassd = 70,
    /// spi_host0_error
    SpiHost0Error = 71,
    /// spi_host0_spi_event
    SpiHost0SpiEvent = 72,
    ...
    AonTimerAonWkupTimerExpired = 74,
    /// aon_timer_aon_wdog_timer_bark
    AonTimerAonWdogTimerBark = 75,
    /// soc_proxy_external 0
    SocProxyExternal0 = 76,
    /// soc_proxy_external 1
    SocProxyExternal1 = 77,
    /// soc_proxy_external 2
    SocProxyExternal2 = 78,
    /// soc_proxy_external 3
    SocProxyExternal3 = 79,
    /// soc_proxy_external 4
    SocProxyExternal4 = 80,
    /// soc_proxy_external 5
    SocProxyExternal5 = 81,
    /// soc_proxy_external 6
    SocProxyExternal6 = 82,
    /// soc_proxy_external 7
    SocProxyExternal7 = 83,
    /// soc_proxy_external 8
    SocProxyExternal8 = 84,
    /// soc_proxy_external 9
    SocProxyExternal9 = 85,
    /// soc_proxy_external 10
    SocProxyExternal10 = 86,
    /// soc_proxy_external 11
    SocProxyExternal11 = 87,
    /// soc_proxy_external 12
    SocProxyExternal12 = 88,
    /// soc_proxy_external 13
    SocProxyExternal13 = 89,
    /// soc_proxy_external 14
    SocProxyExternal14 = 90,
    /// soc_proxy_external 15
    SocProxyExternal15 = 91,
    /// soc_proxy_external 16
    SocProxyExternal16 = 92,
    /// soc_proxy_external 17
    SocProxyExternal17 = 93,
    /// soc_proxy_external 18
    SocProxyExternal18 = 94,
    /// soc_proxy_external 19
    SocProxyExternal19 = 95,
    /// soc_proxy_external 20
    SocProxyExternal20 = 96,
    /// soc_proxy_external 21
    SocProxyExternal21 = 97,
    /// soc_proxy_external 22
    SocProxyExternal22 = 98,
    /// soc_proxy_external 23
    SocProxyExternal23 = 99,
    /// soc_proxy_external 24
    SocProxyExternal24 = 100,
    /// soc_proxy_external 25
    SocProxyExternal25 = 101,
    /// soc_proxy_external 26
    SocProxyExternal26 = 102,
    /// soc_proxy_external 27
    SocProxyExternal27 = 103,
    /// soc_proxy_external 28
    SocProxyExternal28 = 104,
    /// soc_proxy_external 29
    SocProxyExternal29 = 105,
    /// soc_proxy_external 30
    SocProxyExternal30 = 106,
    /// soc_proxy_external 31
    SocProxyExternal31 = 107,
    /// hmac_hmac_done
    HmacHmacDone = 108,
    /// hmac_fifo_empty
    HmacFifoEmpty = 109,
    ...
    CsrngCsCmdReqDone = 116,
    /// csrng_cs_entropy_req
    CsrngCsEntropyReq = 117,
    /// csrng_cs_hw_inst_exc
    CsrngCsHwInstExc = 118,
    /// csrng_cs_fatal_err
    CsrngCsFatalErr = 119,
    /// entropy_src_es_entropy_valid
    EntropySrcEsEntropyValid = 120,
    /// entropy_src_es_health_test_failed
    EntropySrcEsHealthTestFailed = 121,
    /// entropy_src_es_observe_fifo_ready
    EntropySrcEsObserveFifoReady = 122,
    /// entropy_src_es_fatal_err
    EntropySrcEsFatalErr = 123,
    /// edn0_edn_cmd_req_done
    Edn0EdnCmdReqDone = 124,
    /// edn0_edn_fatal_err
    Edn0EdnFatalErr = 125,
    /// edn1_edn_cmd_req_done
    Edn1EdnCmdReqDone = 126,
    /// edn1_edn_fatal_err
    Edn1EdnFatalErr = 127,
    /// dma_dma_done
    DmaDmaDone = 128,
    ...
    RaclCtrlRaclError = 161,
    /// ac_range_check_deny_cnt_reached
    AcRangeCheckDenyCntReached = 162,
}
...
impl TryFrom<u32> for PlicIrqId {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            65 => Ok(Self::OtpCtrlOtpOperationDone),
            66 => Ok(Self::OtpCtrlOtpError),
            67 => Ok(Self::AlertHandlerClassa),
            68 => Ok(Self::AlertHandlerClassb),
            69 => Ok(Self::AlertHandlerClassc),
            70 => Ok(Self::AlertHandlerClassd),
            71 => Ok(Self::SpiHost0Error),
            72 => Ok(Self::SpiHost0SpiEvent),
            73 => Ok(Self::PwrmgrAonWakeup),
            74 => Ok(Self::AonTimerAonWkupTimerExpired),
            75 => Ok(Self::AonTimerAonWdogTimerBark),
            76 => Ok(Self::SocProxyExternal0),
            77 => Ok(Self::SocProxyExternal1),
            78 => Ok(Self::SocProxyExternal2),
            79 => Ok(Self::SocProxyExternal3),
            80 => Ok(Self::SocProxyExternal4),
            81 => Ok(Self::SocProxyExternal5),
            82 => Ok(Self::SocProxyExternal6),
            83 => Ok(Self::SocProxyExternal7),
            84 => Ok(Self::SocProxyExternal8),
            85 => Ok(Self::SocProxyExternal9),
            86 => Ok(Self::SocProxyExternal10),
            87 => Ok(Self::SocProxyExternal11),
            88 => Ok(Self::SocProxyExternal12),
            89 => Ok(Self::SocProxyExternal13),
            90 => Ok(Self::SocProxyExternal14),
            91 => Ok(Self::SocProxyExternal15),
            92 => Ok(Self::SocProxyExternal16),
            93 => Ok(Self::SocProxyExternal17),
            94 => Ok(Self::SocProxyExternal18),
            95 => Ok(Self::SocProxyExternal19),
            96 => Ok(Self::SocProxyExternal20),
            97 => Ok(Self::SocProxyExternal21),
            98 => Ok(Self::SocProxyExternal22),
            99 => Ok(Self::SocProxyExternal23),
            100 => Ok(Self::SocProxyExternal24),
            101 => Ok(Self::SocProxyExternal25),
            102 => Ok(Self::SocProxyExternal26),
            103 => Ok(Self::SocProxyExternal27),
            104 => Ok(Self::SocProxyExternal28),
            105 => Ok(Self::SocProxyExternal29),
            106 => Ok(Self::SocProxyExternal30),
            107 => Ok(Self::SocProxyExternal31),
            108 => Ok(Self::HmacHmacDone),
            109 => Ok(Self::HmacFifoEmpty),
            110 => Ok(Self::HmacHmacErr),
            111 => Ok(Self::KmacKmacDone),
            112 => Ok(Self::KmacFifoEmpty),
            113 => Ok(Self::KmacKmacErr),
            114 => Ok(Self::OtbnDone),
            115 => Ok(Self::KeymgrDpeOpDone),
            116 => Ok(Self::CsrngCsCmdReqDone),
            117 => Ok(Self::CsrngCsEntropyReq),
            118 => Ok(Self::CsrngCsHwInstExc),
            119 => Ok(Self::CsrngCsFatalErr),
            120 => Ok(Self::EntropySrcEsEntropyValid),
            121 => Ok(Self::EntropySrcEsHealthTestFailed),
            122 => Ok(Self::EntropySrcEsObserveFifoReady),
            123 => Ok(Self::EntropySrcEsFatalErr),
            124 => Ok(Self::Edn0EdnCmdReqDone),
            125 => Ok(Self::Edn0EdnFatalErr),
            126 => Ok(Self::Edn1EdnCmdReqDone),
            127 => Ok(Self::Edn1EdnFatalErr),
            128 => Ok(Self::DmaDmaDone),
            129 => Ok(Self::DmaDmaChunkDone),
            130 => Ok(Self::DmaDmaError),
            ...
            161 => Ok(Self::RaclCtrlRaclError),
            162 => Ok(Self::AcRangeCheckDenyCntReached),
            _ => Err(val),
        }
    }
}
...
/// `PlicPeripheral`.
pub const PLIC_INTERRUPT_FOR_PERIPHERAL: [PlicPeripheral; 163] = [
...
impl TryFrom<u32> for AlertId {
    ...
    fn try_from(val: u32) -> Result<Self, Self::Error> {
        match val {
            ...
            4 => Ok(Self::OtpCtrlFatalMacroError),
            5 => Ok(Self::OtpCtrlFatalCheckError),
            6 => Ok(Self::OtpCtrlFatalBusIntegError),
            7 => Ok(Self::OtpCtrlFatalPrimOtpAlert),
            8 => Ok(Self::OtpCtrlRecovPrimOtpAlert),
            9 => Ok(Self::LcCtrlFatalProgError),
            10 => Ok(Self::LcCtrlFatalStateError),
            11 => Ok(Self::LcCtrlFatalBusIntegError),
            12 => Ok(Self::SpiHost0FatalFault),
            13 => Ok(Self::PwrmgrAonFatalFault),
            14 => Ok(Self::RstmgrAonFatalFault),
            15 => Ok(Self::RstmgrAonFatalCnstyFault),
            16 => Ok(Self::ClkmgrAonRecovFault),
            17 => Ok(Self::ClkmgrAonFatalFault),
            18 => Ok(Self::PinmuxAonFatalFault),
            19 => Ok(Self::AonTimerAonFatalFault),
            20 => Ok(Self::SocProxyFatalAlertIntg),
            21 => Ok(Self::SocProxyFatalAlertExternal0),
            22 => Ok(Self::SocProxyFatalAlertExternal1),
            23 => Ok(Self::SocProxyFatalAlertExternal2),
            24 => Ok(Self::SocProxyFatalAlertExternal3),
            25 => Ok(Self::SocProxyFatalAlertExternal4),
            26 => Ok(Self::SocProxyFatalAlertExternal5),
            27 => Ok(Self::SocProxyFatalAlertExternal6),
            28 => Ok(Self::SocProxyFatalAlertExternal7),
            29 => Ok(Self::SocProxyFatalAlertExternal8),
            30 => Ok(Self::SocProxyFatalAlertExternal9),
            31 => Ok(Self::SocProxyFatalAlertExternal10),
            32 => Ok(Self::SocProxyFatalAlertExternal11),
            33 => Ok(Self::SocProxyFatalAlertExternal12),
            34 => Ok(Self::SocProxyFatalAlertExternal13),
            35 => Ok(Self::SocProxyFatalAlertExternal14),
            36 => Ok(Self::SocProxyFatalAlertExternal15),
            37 => Ok(Self::SocProxyFatalAlertExternal16),
            38 => Ok(Self::SocProxyFatalAlertExternal17),
            39 => Ok(Self::SocProxyFatalAlertExternal18),
            40 => Ok(Self::SocProxyFatalAlertExternal19),
            41 => Ok(Self::SocProxyFatalAlertExternal20),
            42 => Ok(Self::SocProxyFatalAlertExternal21),
            43 => Ok(Self::SocProxyFatalAlertExternal22),
            44 => Ok(Self::SocProxyFatalAlertExternal23),
            45 => Ok(Self::SocProxyRecovAlertExternal0),
            46 => Ok(Self::SocProxyRecovAlertExternal1),
            47 => Ok(Self::SocProxyRecovAlertExternal2),
            48 => Ok(Self::SocProxyRecovAlertExternal3),
            49 => Ok(Self::SramCtrlRetAonFatalError),
            50 => Ok(Self::RvPlicFatalFault),
            51 => Ok(Self::AesRecovCtrlUpdateErr),
            52 => Ok(Self::AesFatalFault),
            53 => Ok(Self::HmacFatalFault),
            54 => Ok(Self::KmacRecovOperationErr),
            55 => Ok(Self::KmacFatalFaultErr),
            56 => Ok(Self::OtbnFatal),
            57 => Ok(Self::OtbnRecov),
            58 => Ok(Self::KeymgrDpeRecovOperationErr),
            59 => Ok(Self::KeymgrDpeFatalFaultErr),
            60 => Ok(Self::CsrngRecovAlert),
            61 => Ok(Self::CsrngFatalAlert),
            62 => Ok(Self::EntropySrcRecovAlert),
            63 => Ok(Self::EntropySrcFatalAlert),
...
pub const TOP_DARJEELING_NO_IBEX_MMIO_BASE_ADDR: usize = 0x21100000;
pub const TOP_DARJEELING_NO_IBEX_MMIO_SIZE_BYTES: usize = 0xF501000;
