...
//
// xbar_peri_no_ibex module generated by `tlgen.py` tool
...
module xbar_peri_no_ibex (
  input clk_peri_i,
  input rst_peri_ni,

  // Host interfaces
  input  tlul_pkg::tl_h2d_t tl_main_no_ibex_i,
  output tlul_pkg::tl_d2h_t tl_main_no_ibex_o,
  ...
  assign tl_s1n_20_us_h2d = tl_main_no_ibex_i;
  assign tl_main_no_ibex_o = tl_s1n_20_us_d2h;
