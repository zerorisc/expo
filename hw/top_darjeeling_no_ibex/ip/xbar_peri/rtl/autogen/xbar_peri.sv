...
module xbar_peri (
  ...
  assign tl_uart0_o = tl_s1n_19_ds_h2d[0];
  assign tl_s1n_19_ds_d2h[0] = tl_uart0_i;

  assign tl_i2c0_o = tl_s1n_19_ds_h2d[1];
  assign tl_s1n_19_ds_d2h[1] = tl_i2c0_i;

  assign tl_gpio_o = tl_s1n_19_ds_h2d[2];
  assign tl_s1n_19_ds_d2h[2] = tl_gpio_i;

  assign tl_spi_host0_o = tl_s1n_19_ds_h2d[3];
  assign tl_s1n_19_ds_d2h[3] = tl_spi_host0_i;

  assign tl_spi_device_o = tl_s1n_19_ds_h2d[4];
  assign tl_s1n_19_ds_d2h[4] = tl_spi_device_i;

  assign tl_pwrmgr_aon_o = tl_s1n_19_ds_h2d[5];
  assign tl_s1n_19_ds_d2h[5] = tl_pwrmgr_aon_i;

  assign tl_rstmgr_aon_o = tl_s1n_19_ds_h2d[6];
  assign tl_s1n_19_ds_d2h[6] = tl_rstmgr_aon_i;

  assign tl_clkmgr_aon_o = tl_s1n_19_ds_h2d[7];
  assign tl_s1n_19_ds_d2h[7] = tl_clkmgr_aon_i;

  assign tl_pinmux_aon_o = tl_s1n_19_ds_h2d[8];
  assign tl_s1n_19_ds_d2h[8] = tl_pinmux_aon_i;

  assign tl_otp_ctrl__core_o = tl_s1n_19_ds_h2d[9];
  assign tl_s1n_19_ds_d2h[9] = tl_otp_ctrl__core_i;

  assign tl_otp_macro__prim_o = tl_s1n_19_ds_h2d[10];
  assign tl_s1n_19_ds_d2h[10] = tl_otp_macro__prim_i;

  assign tl_lc_ctrl__regs_o = tl_s1n_19_ds_h2d[11];
  assign tl_s1n_19_ds_d2h[11] = tl_lc_ctrl__regs_i;

  assign tl_alert_handler_o = tl_s1n_19_ds_h2d[12];
  assign tl_s1n_19_ds_d2h[12] = tl_alert_handler_i;

  assign tl_ast_o = tl_s1n_19_ds_h2d[13];
  assign tl_s1n_19_ds_d2h[13] = tl_ast_i;

  assign tl_sram_ctrl_ret_aon__ram_o = tl_s1n_19_ds_h2d[14];
  assign tl_s1n_19_ds_d2h[14] = tl_sram_ctrl_ret_aon__ram_i;

  assign tl_sram_ctrl_ret_aon__regs_o = tl_s1n_19_ds_h2d[15];
  assign tl_s1n_19_ds_d2h[15] = tl_sram_ctrl_ret_aon__regs_i;

  assign tl_aon_timer_aon_o = tl_s1n_19_ds_h2d[16];
  assign tl_s1n_19_ds_d2h[16] = tl_aon_timer_aon_i;

  assign tl_soc_dbg_ctrl__core_o = tl_s1n_19_ds_h2d[17];
  assign tl_s1n_19_ds_d2h[17] = tl_soc_dbg_ctrl__core_i;

  assign tl_s1n_19_us_h2d = tl_main_i;
  assign tl_main_o = tl_s1n_19_us_d2h;
