...
/// Peripheral base address for dmi device on lc_ctrl in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const LC_CTRL_DMI_BASE_ADDR: usize = 0x3000;

/// Peripheral size for dmi device on lc_ctrl in top crossbar.
///
...
/// Peripheral base address for dbg device on rv_dm in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RV_DM_DBG_BASE_ADDR: usize = 0x0;

/// Peripheral size for dbg device on rv_dm in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for soc device on mbx_jtag in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX_JTAG_SOC_BASE_ADDR: usize = 0x2200;

/// Peripheral size for soc device on mbx_jtag in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for jtag device on soc_dbg_ctrl in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const SOC_DBG_CTRL_JTAG_BASE_ADDR: usize = 0x2300;

/// Peripheral size for jtag device on soc_dbg_ctrl in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
