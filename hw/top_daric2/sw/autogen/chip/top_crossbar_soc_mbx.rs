...
/// Peripheral base address for soc device on mbx0 in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX0_SOC_BASE_ADDR: usize = 0x1465000;

/// Peripheral size for soc device on mbx0 in top crossbar.
///
...
/// Peripheral base address for soc device on mbx1 in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX1_SOC_BASE_ADDR: usize = 0x1465100;

/// Peripheral size for soc device on mbx1 in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for soc device on mbx2 in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX2_SOC_BASE_ADDR: usize = 0x1465200;

/// Peripheral size for soc device on mbx2 in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for soc device on mbx3 in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX3_SOC_BASE_ADDR: usize = 0x1465300;

/// Peripheral size for soc device on mbx3 in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for soc device on mbx4 in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX4_SOC_BASE_ADDR: usize = 0x1465400;

/// Peripheral size for soc device on mbx4 in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for soc device on mbx5 in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX5_SOC_BASE_ADDR: usize = 0x1465500;

/// Peripheral size for soc device on mbx5 in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for soc device on mbx6 in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const MBX6_SOC_BASE_ADDR: usize = 0x1496000;

/// Peripheral size for soc device on mbx6 in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for racl_ctrl in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const RACL_CTRL_BASE_ADDR: usize = 0x1461F00;

/// Peripheral size for racl_ctrl in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
...
/// Peripheral base address for ac_range_check in top crossbar.
///
/// This should be used with #mmio_region_from_addr to access the memory-mapped
/// registers associated with the peripheral (usually via a DIF).
pub const AC_RANGE_CHECK_BASE_ADDR: usize = 0x1464000;

/// Peripheral size for ac_range_check in top crossbar.
///
/// This is the size (in bytes) of the peripheral's reserved memory area. All
/// memory-mapped registers associated with this peripheral should have an
