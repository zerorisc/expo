...
#(
  ...
  logic [10:0][PowerDomains-1:0] cnsty_chk_errs;
  logic [10:0][PowerDomains-1:0] shadow_cnsty_chk_errs;

  // consistency sparse fsm errors
  logic [10:0][PowerDomains-1:0] fsm_errs;
  logic [10:0][PowerDomains-1:0] shadow_fsm_errs;
  ...
  rstmgr_leaf_rst #(
    ...
    .err_o(shadow_cnsty_chk_errs[8][DomainAonSel]),
