...
package rv_plic_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    rv_plic_reg2hw_prio_mreg_t [128:0] prio; // [401:144]
    rv_plic_reg2hw_ie0_mreg_t [128:0] ie0; // [143:15]
  ...
  // HW -> register type
  typedef struct packed {
    rv_plic_hw2reg_ip_mreg_t [128:0] ip; // [265:8]
  ...
  parameter logic [3:0] RV_PLIC_PERMIT [143] = '{
    ...
    4'b 1111, // index[129] RV_PLIC_IP_0
    4'b 1111, // index[130] RV_PLIC_IP_1
    4'b 1111, // index[131] RV_PLIC_IP_2
    4'b 1111, // index[132] RV_PLIC_IP_3
    4'b 0001, // index[133] RV_PLIC_IP_4
    4'b 1111, // index[134] RV_PLIC_IE0_0
    4'b 1111, // index[135] RV_PLIC_IE0_1
    4'b 1111, // index[136] RV_PLIC_IE0_2
    4'b 1111, // index[137] RV_PLIC_IE0_3
    4'b 0001, // index[138] RV_PLIC_IE0_4
    4'b 0001, // index[139] RV_PLIC_THRESHOLD0
    4'b 0001, // index[140] RV_PLIC_CC0
    4'b 0001, // index[141] RV_PLIC_MSIP0
    4'b 0001  // index[142] RV_PLIC_ALERT_TEST
  };
