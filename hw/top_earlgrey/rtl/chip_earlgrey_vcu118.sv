...
//
// This file was generated by hand, using chip_earlgrey_cw340.sv as a base.
// A differential clock is used as the system clock, and the pad wrappers are
// not yet able to handle it (so neither is the padring).

module chip_earlgrey_vcu118 #(
  ...
  input IO_CLK_P, // Manual Pad
  input IO_CLK_N, // Manual Pad
...
// otherwise Verilator / FPGA will hang.
  ...
  assign manual_out_io_clkout = 1'b1; //manual_in_io_clk;
...
endmodule : chip_earlgrey_vcu118
