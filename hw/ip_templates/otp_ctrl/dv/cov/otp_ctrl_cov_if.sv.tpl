...
% if enable_flash_key:
  covergroup flash_data_req_condition_cg @(flash_otp_key_i.data_req);
    ...
    flash_data_req_during_acc_req:       coverpoint acc_otp_key_i.req;
  ...
  covergroup flash_addr_req_condition_cg @(flash_otp_key_i.addr_req);
    ...
    flash_addr_req_during_acc_req:       coverpoint acc_otp_key_i.req;
...
% endif
  ...
  % if enable_flash_key:
    acc_req_during_flash_addr_req: coverpoint flash_otp_key_i.addr_req;
    acc_req_during_flash_data_req: coverpoint flash_otp_key_i.data_req;
  % endif
