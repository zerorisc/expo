...
class gpio_data_agent extends dv_base_agent #(.CFG_T(gpio_data_in_agent_cfg),
                                                 .DRIVER_T(gpio_data_driver),
                                                 .SEQUENCER_T(data_sequencer),
  ...
  function void build_phase(uvm_phase phase);
    ...
    cfg = gpio_data_in_agent_cfg::type_id::create("cfg", this);

    // Set the agent cfg in the config DB
    uvm_config_db#(gpio_data_in_agent_cfg)::set(this, "", "cfg", cfg);
    // Set the agent cfg in the config DB that is used in the data_in monitor and driver.
    uvm_config_db#(gpio_data_in_agent_cfg)::set(this, "*", "sub_cfg", cfg);
...
function gpio_data_in_agent::new(string name, uvm_component parent);
