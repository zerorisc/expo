...
#(
  ...
  assign current_loop_counter_dec = ~state_reset_i & ~acc_stall_i & at_current_loop_end_insn;
  ...
  // The ACC controller must not commit a loop request if it sees a loop error.
