...
#(
  ...
  // Immediates specific to ACC encoding
  ...
  assign insn_dec_bignum_o = '{
    ...
    vector_type:         AccPQCEn ? alu_vector_type_bignum_pqc : alu_vector_type_t'(2'b0),
    vector_sel:          AccPQCEn ? alu_vector_sel_bignum_pqc : 1'b0,
    alu_trn_type:        AccPQCEn ? alu_trn_type_bignum_pqc : alu_trn_type_t'(3'b0),
    // Normal assignments
    ...
    // Vector assignments depend on PQC parameter
    mac_mulv:            AccPQCEn ? mac_mulv_pqc : 1'b0,
    mac_data_type:       AccPQCEn ? mac_data_type_pqc : 1'b0,
    mac_sel:             AccPQCEn ? mac_sel_pqc : 1'b0,
    mac_lane_mode:       AccPQCEn ? mac_lane_mode_pqc : 1'b0,
    mac_lane_word_32:    AccPQCEn ? mac_lane_word_32_pqc : 1'b0,
    mac_lane_word_16:    AccPQCEn ? mac_lane_word_16_pqc : 1'b0,
    mac_exec_mode:       AccPQCEn ? mac_exec_mode_pqc : 2'b00,
    // Normal assignments
    ...
    unique case (opcode)
      ...
      InsnOpcodeBignumArith: begin
        ...
        unique case(insn[14:12])
          ...
          // that should not be valid outside AccPQCEn
          3'b101: begin
