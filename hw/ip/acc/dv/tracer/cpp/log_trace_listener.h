...
#ifndef OPENTITAN_HW_IP_ACC_DV_TRACER_CPP_LOG_TRACE_LISTENER_H_
#define OPENTITAN_HW_IP_ACC_DV_TRACER_CPP_LOG_TRACE_LISTENER_H_
...
/**
 * An AccTraceListener that dumps the trace to a log file, with some minimal
 * pretty printing.
 *
 ...
 * four spaces.
 */
class LogTraceListener : public AccTraceListener {
 private:
...
#endif  // OPENTITAN_HW_IP_ACC_DV_TRACER_CPP_LOG_TRACE_LISTENER_H_
