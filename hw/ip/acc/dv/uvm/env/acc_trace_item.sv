...
class acc_trace_item extends uvm_sequence_item;
  ...
  acc_pkg::flags_t flags_read_data [2];
  logic [1:0]       flags_write_valid;
  acc_pkg::flags_t flags_write_data [2];
  ...
  `uvm_object_utils_begin(acc_trace_item)
