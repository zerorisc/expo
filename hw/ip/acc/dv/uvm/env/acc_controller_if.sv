...
//
// Bound into the acc_controller and used to help collect ISPR information for coverage.

interface acc_controller_if
  import acc_pkg::*;
(
  input         clk_i,
  input         rst_ni,

  // Signal names from the acc_controller module (where we are bound)
