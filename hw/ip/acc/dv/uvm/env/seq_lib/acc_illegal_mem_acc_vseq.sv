...
// A sequence to do illegal read and write accesses to the imem when the acc is busy

class acc_illegal_mem_acc_vseq extends acc_single_vseq;
  `uvm_object_utils(acc_illegal_mem_acc_vseq)
  `uvm_object_new
...
endclass : acc_illegal_mem_acc_vseq
