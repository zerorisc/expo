...
class acc_multi_vseq extends acc_base_vseq;
  `uvm_object_utils(acc_multi_vseq)
  ...
  task body();
    ...
    for (int i = 0; i < 10; i++) begin
      ...
      fork
        ...
        begin
          if (rerun) begin
            `uvm_info(`gfn, $sformatf("Re-using ACC binary at `%0s'", elf_path), UVM_LOW)
          end else begin
