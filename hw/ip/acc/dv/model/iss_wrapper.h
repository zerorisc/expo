...
#ifndef OPENTITAN_HW_IP_ACC_DV_MODEL_ISS_WRAPPER_H_
#define OPENTITAN_HW_IP_ACC_DV_MODEL_ISS_WRAPPER_H_
...
// ACC has some externally visible CSRs that can be updated by hardware
...
struct ISSWrapper {
  ...
  //
  // If gen_trace is true, pass trace data to the (singleton) AccTraceChecker
  // object.
  //
  ...
  // AccTraceChecker to clear out any partial instructions. It also resets
...
#endif  // OPENTITAN_HW_IP_ACC_DV_MODEL_ISS_WRAPPER_H_
