...
// Backdoor interface that can be bound into an ACC stack and exports a function to peek at
// the stack contents.

`ifndef SYNTHESIS
interface acc_stack_snooper_if #(
  ...
  export "DPI-C" function acc_stack_element_peek;

  function automatic int acc_stack_element_peek(input int index, output bit [255:0] val);
    // Return 2 for issues indicating a broken usage of acc_stack_element_peek
