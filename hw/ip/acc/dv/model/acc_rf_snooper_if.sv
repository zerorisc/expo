...
// Backdoor interface that can be bound into an ACC register file and exports a function to peek at
// the memory contents.

`ifndef SYNTHESIS
interface acc_rf_snooper_if #(
  ...
  export "DPI-C" function acc_rf_peek;
  ...
  function automatic int acc_rf_peek(input int index, output bit [255:0] val);
