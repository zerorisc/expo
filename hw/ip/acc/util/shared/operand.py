...
class OperandType:
    ...
    assembly listing (either fed into acc_as.py, or generated by
    acc_objdump.py). The encoded value is the non-negative integer value that
    ...
    def op_val_to_enc_val(self, op_val: int,
        ...
        this is acc_as.py, and we don't know our eventual current address), a
