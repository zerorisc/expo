...
def _get_pcs_for_mnemonics(program: ACCProgram,
...
def _check_loop_iterations(program: ACCProgram,
...
def _check_loop_end_insns(program: ACCProgram,
                          loops: List[CodeSection]) -> CheckResult:
...
def _check_loop_inclusion(program: ACCProgram,
                          loops: List[CodeSection]) -> CheckResult:
...
def _check_loop_branching(program: ACCProgram,
                          loops: List[CodeSection]) -> CheckResult:
...
def _check_loop_stack(program: ACCProgram,
                      loops: List[CodeSection]) -> CheckResult:
    '''Checks that loops will likely be properly cleared from loop stack.

    The checks here are based on the ACC hardware IP documentation on loop
...
def check_loop(program: ACCProgram) -> CheckResult:
