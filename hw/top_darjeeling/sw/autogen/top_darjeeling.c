...
const top_darjeeling_alert_peripheral_t
  ...
  [kTopDarjeelingAlertIdAccFatal] = kTopDarjeelingAlertPeripheralAcc,
  [kTopDarjeelingAlertIdAccRecov] = kTopDarjeelingAlertPeripheralAcc,
...
const top_darjeeling_plic_peripheral_t
  ...
  [kTopDarjeelingPlicIrqIdAccDone] = kTopDarjeelingPlicPeripheralAcc,
